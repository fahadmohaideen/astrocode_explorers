...
class FreeWorld:
    def __init__(self):
        ...
        self.close_button = Button(WIDTH - 100, HEIGHT - 80, 40, 40, "x", (150, 0, 0), (255, 50, 50),
                                   fonts['menu_font'])
    ...
    def handle_event(self, event, mouse_pos):
        ...
        if self.panel_visible and self.close_button.is_clicked(mouse_pos, event):
    ...
    def update(self, dt, keys):
        ...
        if dx != 0 or dy != 0:
            ...
            self.current_frame = 0  # Reset to idle when not moving
