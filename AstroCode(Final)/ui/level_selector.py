...
class LevelSelector:
    def __init__(self, menu_font, title_font):
        ...
        self.free_roam_button = Button(WIDTH // 2 - 100, HEIGHT // 2 + 70, 200, 50, "Free Roam", BLUE, CYAN,
                                       self.menu_font)
    ...
    def draw(self, surface):
        ...
        self.free_roam_button.draw(surface)

    def handle_click(self, pos, event):
        if self.free_roam_button.is_clicked(pos, event):
            return "free_roam"  # We'll treat 0 as the Free Roam state
