...
# Mock pygame to allow testing without a display
...
# Mock pygame.math.Vector2 separately as it's a specific class
class MockVector2:
...
# Patch pygame.Vector2 before importing other modules that use it
...
# Mock constants, ensuring they are accessible when imported by other modules
